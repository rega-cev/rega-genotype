...
public class HcvMain extends GenotypeMain {
	...
	public WApplication createApplication(WEnvironment env) {
		...
		resources.use("/rega/genotype/ui/viruses/hcv/resources");
		app.setLocalizedStrings(resources);
		
		app.useStyleSheet(new WLink("../style/hcv/genotype.css"));
		
		GenotypeWindow window = new GenotypeWindow(new HcvDefinition());
