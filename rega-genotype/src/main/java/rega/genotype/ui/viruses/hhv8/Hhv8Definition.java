 ...
 * @author plibin0
 */
public class Hhv8Definition implements OrganismDefinition {
	private Genome genome = new Genome(new Hhv8Genome(this));
	...
	public String getOrganismDirectory() {
		return "/rega/genotype/ui/viruses/hhv8/";
	}
	...
	public void startAnalysis(File jobDir) throws IOException,
		...
		HHV8Tool hhv8 = new HHV8Tool(jobDir);
		hhv8.analyze(jobDir.getAbsolutePath() + File.separatorChar + "sequences.fasta",
