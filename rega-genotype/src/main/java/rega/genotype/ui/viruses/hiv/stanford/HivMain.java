 ...
 */
package rega.genotype.ui.viruses.hiv.stanford;
...
/**
 * HIV implementation of the genotype application (Stanford implementation).
 * 
 * @author simbre1
 *
 */
...
public class HivMain extends GenotypeMain {
	public static final String HIV_STANFORD_URL = "stanford-hiv"; // TODO: Temporary till hiv becomes generic tool.

	@Override
	public WApplication createApplication(WEnvironment env) {
		GenotypeApplication app = new GenotypeApplication(env, this.getServletContext(), settings, HIV_STANFORD_URL);
		...
		resources.use("/rega/genotype/ui/viruses/hiv/stanford/resources");
		app.setLocalizedStrings(resources);
		
		app.useStyleSheet(new WLink("../style/hiv/stanford.css"));
