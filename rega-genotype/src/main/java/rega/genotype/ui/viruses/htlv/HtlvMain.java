...
/**
 * HTLV implementation of the genotype application.
 * 
 * @author murilo
 *
 */
...
public class HtlvMain extends GenotypeMain {
	...
	public WApplication createApplication(WEnvironment env) {
		...
		resources.use("/rega/genotype/ui/viruses/htlv/resources");
		app.setLocalizedStrings(resources);
		
		app.useStyleSheet(new WLink("../style/htlv/genotype.css"));
		
		GenotypeWindow window = new GenotypeWindow(new HtlvDefinition());
