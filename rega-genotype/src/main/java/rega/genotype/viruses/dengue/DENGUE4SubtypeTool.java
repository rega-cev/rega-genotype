...
public class DENGUE4SubtypeTool extends GenotypeTool {
    private AlignmentAnalyses dengue4;
    private PhyloClusterAnalysis pureAnalysis;


    public DENGUE4SubtypeTool(File workingDir) throws FileFormatException, IOException, ParameterProblemException {
        dengue4 = readAnalyses("DENGUE/dengue4.xml", workingDir);
        pureAnalysis = (PhyloClusterAnalysis) dengue4.getAnalysis("pure");
           ...
           PhyloClusterAnalysis.Result pureresult = pureAnalysis.run(s);
                ...
                if (pureresult.haveSupport()) {
                    conclude (pureresult, 
                            ...
                            + "clustering with a DENGUE4 subtype and/or subgroup with bootstrap > 75% ");
                    return;
                } else {
    ...
    public void analyzeSelf() throws AnalysisException {
        ScanAnalysis scanPureSelfAnalysis
            = (ScanAnalysis) dengue4.getAnalysis("scan-pure-self");
