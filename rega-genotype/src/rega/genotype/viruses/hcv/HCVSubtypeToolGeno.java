...
public class HCVSubtypeToolGeno extends GenotypeTool {
    ...
    public HCVSubtypeToolGeno() throws IOException, ParameterProblemException, FileFormatException {
        hcv = readAnalyses("hcvgeno.xml");
